...
{
    public class TipoCombuCrudFactory : CrudFactory
    {

        TipoCombuMapper mapper;

        public TipoCombuCrudFactory() : base()
        {
            mapper = new TipoCombuMapper();
            dao = SqlDao.GetInstance();
        }

        public override void Create(BaseEntity entity)
        {
            var customer = (VehiOpcion)entity;
